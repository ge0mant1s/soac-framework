...
# SOaC Framework - AWS Infrastructure using Terraform
# Deploys SOaC Framework to AWS using ECS Fargate, RDS, and ALB
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        ...
        {
          name      = "SECRET_KEY"
          valueFrom = "${aws_secretsmanager_secret.db_credentials.arn}:secret_key::"
        }
      ]
